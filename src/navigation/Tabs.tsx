...
import ProfileStack from './ProlifeStack';
  ...
  let tabs = [
    {
      ...
      icon: () => <R.icons.HomeIcon color={'#CCD1D1'} />,
      iconActive: () => <R.icons.HomeIcon color={'#212F3C'} />,
      badge: false,
    },
    {
      label: 'Корзина',
      name: R.routes.STACK_CART,
      component: CartStack,
      icon: () => <R.icons.CartIcon color={'#CCD1D1'} />,
      iconActive: () => <R.icons.CartIcon color={'#212F3C'} />,
    },
    {
      label: 'Профиль',
